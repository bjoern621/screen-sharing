...
// A test matching on wording would assert the one thing this package does not decide, and would
// break the first time a shell reworded its screen (api/proto/screenshare/v1/text.proto).
...
// Absence is an answer: a statement names a value some combinations have and others do not, and a
// caller with none states the shorter form of the same fact.
