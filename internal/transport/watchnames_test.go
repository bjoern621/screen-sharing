...
// The browser is the third reader, and its list is neither of the other two: it is
// the legs the relay serves a player page for. WHEP is on it and no player opens
// it, and SRT is off it although both other readers take it, because a browser
// reaches a relay listener over HTTP and nothing else.
