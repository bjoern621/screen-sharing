...
//
// It is the receive-side counterpart of ViewerStateEvent, and it carries decodes
// rather than tiles: how a shell arranges what it receives is the shell's, and is on
// no message this package writes.
...
// inside this process rather than as a child, so there is no run log of its own to
// offer.
