...
// legEnum converts a leg of a transport's carriage.
...
// colourEnum converts a GPU path's colour verdict.
...
// gpuPathImport states what carries the frames across one pair's device path.
