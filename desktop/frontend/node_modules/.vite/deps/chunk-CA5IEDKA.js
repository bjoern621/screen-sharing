...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React27 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef20 = React27.useRef, useEffect10 = React27.useEffect, useMemo15 = React27.useMemo, useDebugValue2 = React27.useDebugValue;
...
function fastComponentRef(fn) {
  return React3.forwardRef(fastComponent(fn));
}
...
var ReactStore = class extends Store {
  ...
  useSyncedValues(statePart) {
    const store = this;
    if (true) {
      React5.useDebugValue(statePart, (p) => Object.keys(p));
      const keys = React5.useRef(Object.keys(statePart)).current;
   ...
   */
  useStateSetter(key) {
    const ref = React5.useRef(void 0);
...
var FloatingDelayGroupContext = React8.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
function FloatingDelayGroup(props) {
  ...
  const delayRef = React8.useRef(delay);
  const initialDelayRef = React8.useRef(delay);
  const currentIdRef = React8.useRef(null);
  const currentContextRef = React8.useRef(null);
...
function useDelayGroup(context, options = {
  ...
  const groupContext = React8.useContext(FloatingDelayGroupContext);
  const {
    currentIdRef,
    delayRef,
    timeoutMs,
  ...
  const [isInstantPhase, setIsInstantPhase] = React8.useState(false);
  const openRef = React8.useRef(open);
  const isUnmountedRef = React8.useRef(false);
  useIsoLayoutEffect(() => {
...
var FocusGuard = React9.forwardRef(function FocusGuard2(props, ref) {
...
var FloatingPortal = React10.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  return (0, import_jsx_runtime4.jsxs)(React10.Fragment, {
...
var useFloatingParentNodeId = () => {
  var _a;
  return ((_a = React11.useContext(FloatingNodeContext)) == null ? void 0 : _a.id) || null;
};
...
function useDismiss(context, props = {}) {
  ...
  React15.useEffect(clearInsideReactTree, [outsidePress, clearInsideReactTree]);
...
function useTypeahead(context, props) {
  ...
  const sharedProps = React23.useMemo(() => ({
    onKeyDown,
    onBlur
  }), [onKeyDown, onBlur]);
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React26.useState(null);
  ...
  const arrowRef = React26.useRef(null);
  ...
  const autoUpdateOptions = React26.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React26.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CA5IEDKA.js.map
