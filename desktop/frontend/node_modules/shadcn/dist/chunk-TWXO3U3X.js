...
`),r={};for(let s of t){let i=s.trim();if(!i||i.startsWith("#"))continue;let n=i.indexOf("=");if(n===-1)continue;let o=i.substring(0,n).trim(),c=i.substring(n+1).trim();o&&(r[o]=c.replace(/^["']|["']$/g,""));}return r}function Bs(e,t){let r=Pe(e),s=Pe(t),i=[];for(let n of Object.keys(s))n in r||i.push(n);return i}function qs(e,t){let r=Pe(e),s=Pe(t),i=e.trimEnd();i&&!i.endsWith(`
`)&&(i+=`
...
`)}export{Vf as $,Vs as A,Sw as Aa,Re as B,Cw as Ba,Ks as C,ao as Ca,Bs as D,dh as Da,qs as E,ph as Ea,Ee as F,$w as Fa,Tt as G,re as Ga,At as H,od as Ha,jt as I,kt as Ia,_t as J,ad as Ja,ei as K,kh as Ka,ti as L,Th as La,kp as M,uo as Ma,Nt as N,Ph as Na,Mt as O,Ah as Oa,Ja as P,Ww as Pa,ci as Q,wh as Qa,_ as R,Sh as Ra,zp as S,Hw as Sa,Ze as T,zw as Ta,Wf as U,Hf as V,zf as W,Uf as X,Et as Y,Je as Z,It as _,F as a,ta as aa,D as b,sa as ba,Wh as c,Gf as ca,Hh as d,Hs as da,T as e,Oe as ea,S as f,Ie as fa,pf as g,lm as ga,mf as h,je as ha,gf as i,Um as ia,Mo as j,sg as ja,N as k,me as ka,j as l,Zi as la,ve as m,sh as ma,We as n,By as na,He as o,io as oa,ze as p,Fe as pa,ae as q,hs as qa,ee as r,uh as ra,M as s,hh as sa,C as t,bw as ta,be as u,St as ua,Ue as v,Rw as va,Ve as w,Ew as wa,Ge as x,Iw as xa,ce as y,Lt as ya,le as z,fh as za};