...
using ScreenShare.App.Features.Insights.ConfigCard.ViewModel;
using ScreenShare.App.Features.Insights.HeaderStats.ViewModel;
using ScreenShare.App.Features.Insights.Model;
using ScreenShare.App.Features.Insights.Plots.Model;
...
/// </summary>
public sealed class InsightsFiguresTests
{
    ...
    {
        var reading = InsightsSnapshot.Of(Live(), Sample(4, 3_671), null);
    ...
    {
        var reading = InsightsSnapshot.Of(Live(), null, null);
    ...
    /// </summary>
    [Fact]
    public void TheStripReachesInsightsWithNothingPublishing()
    {
    ...
    public void TheHeaderFiguresAreTheSamplesAndTheRelays()
    {
        ...
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(4.25, 12), relay),
        };
    ...
    public void AGroupedPublishReadsItsOwnRelayRow()
    {
        ...
        Assert.Equal(2, InsightsSnapshot.Of(live, null, relay).Viewers);
    }
    ...
    public void AFigureNothingMeasuresReadsAsAbsentRatherThanAsZero()
    {
        var bar = new HeaderStatsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(4.25, 12), null),
        };
    ...
    public void ThePlotStatesTheWindowItCoversWhateverTheRunHasReached()
    {
        ...
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(4, 30), null),
        ...
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(4, 400), null),
    ...
    public void APointIsPlacedByWhenItWasTakenAndNotByHowManyThereAre()
    {
        var young = new PlotsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(4, 15), null),
    ...
    public void ARelaunchedPipelineIsNotDrawnOverTheOneBeforeIt()
    {
        ...
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(4, 2), null),
    ...
    public void ARunThatHasBeenTimedAndNotYetMeasuredDrawsNothing()
    {
        var plots = new PlotsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(), Timed(0), null),
    ...
    public void APlotWithNoCurveStatesNoWindow()
    {
        var plots = new PlotsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(), null, null),
        };
    ...
    public void TheCeilingRuleSitsWhereTheCeilingFallsOnTheCurve()
    {
        ...
        var plots = new PlotsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(ceilingMbps: 4), Sample(5, 20), null),
    ...
    public void ACeilingTheStreamIsNowhereNearIsMarkedByNoRule()
    {
        var plots = new PlotsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(ceilingMbps: 20), Sample(5, 20), null),
            Samples = [Sample(3, 10), Sample(5, 20)],
        };
    ...
    {
        var reading = InsightsSnapshot.Of(Live(), Sample(4, 12), null);
    ...
    public void AFigureNoPassMeasuredReadsTheLastOneThatDid()
    {
        ...
        held.Fill(InsightsSnapshot.Of(Live(), Encoded(20.5, 12), null));
        var reading = held.Fill(InsightsSnapshot.Of(Live(), Timed(13), null));
    ...
    public void AStoppedStreamHoldsNothingForTheNextOne()
    {
        ...
        var idle = held.Fill(InsightsSnapshot.Of(new PublishState(), null, null));

        Assert.Null(idle.EncodeMs);

        var next = held.Fill(InsightsSnapshot.Of(Live(), Timed(1), null));
    ...
    {
        var held = new HeldFigures();
        held.Fill(InsightsSnapshot.Of(Live(), Timed(12), Roster(rttMs: 42)));

        var reading = held.Fill(InsightsSnapshot.Of(Live(), Timed(13), Roster(rttMs: null)));
    ...
    public void AnUnboundedEncodeIsMarkedByNoCeiling()
    {
        var plots = new PlotsViewModel
        {
            Snapshot = InsightsSnapshot.Of(Live(), Sample(5, 20), null),
            Samples = [Sample(3, 10), Sample(5, 20)],
        };
