...
/// <summary>
/// The on-air pill: a solid white dot, a label, and a running figure. It carries the one
/// red in the palette, so it is the single element on any screen that says the world is
/// being changed right now.
///
/// Not a general-purpose badge. A pill that meant anything other than "on air" would
/// spend the red on state that is merely on.
/// </summary>
public sealed class StatusPill : TemplatedControl
{
    /// <summary>Prose, sentence case. In practice "On air".</summary>
