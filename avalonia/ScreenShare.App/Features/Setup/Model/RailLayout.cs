...
/// quantizer.
/// What the field is called, what it holds, what it may hold and whether it is reachable stays the form's
/// answer.
///
/// The rail <b>reads</b> it beside the bar it is the limit of, because a capacity three steps from the
/// prediction it bounds is a number the reader has to remember rather than see.
/// A reading and not a control: a second box here would be two controls over one value, so the panel names
/// the step that owns it instead.
///
