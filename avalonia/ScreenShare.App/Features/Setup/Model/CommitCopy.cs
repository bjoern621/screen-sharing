...
///
/// <b>One row per <see cref="PublishCommit"/>, read whole by the view model.</b> A conditional at each binding
...
public static class CommitCopy
{
    ...
    /// <summary>
    /// Exhaustive: a commit this table has no row for fails here rather than drawing a button labelled after
    /// another effect.
    /// </summary>
