...
/// <summary>
/// One saved preset, as the card draws it: what it is called, whether the draft is it, and the two things
...
public sealed record PresetRow
{
    ...
    /// A snapshot carries no claim about a region of the settings, so being selected can only mean being
    /// equal: an edit that moves one field off it unmarks the row, and there is no stored selection left to
    /// disagree with the settings (<c>docs/presets.md</c>, "Saved presets").
    /// </summary>
