...
///
/// A record, the tile and the command handed in rather than made here, so two passes over one unchanged screen
/// compare equal.
...
/// </param>
/// <param name="Label">
/// What the screen is called, written by this shell out of the catalog:
/// <c>Screen 1 · 2560 × 1440 · 144 Hz · main</c>, without the rate where the output reports none.
/// </param>
...
/// Made no earlier on purpose: a tile subscribes to frames when it is drawn, and a subscription naming a screen
/// nothing is reading is refused once and never retried, so a tile built ahead of the preview stays dark for as
/// long as the step is open.
/// </param>
