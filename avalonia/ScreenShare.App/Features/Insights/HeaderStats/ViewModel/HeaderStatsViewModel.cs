...
using ScreenShare.App.Features.Insights.HeaderStats.Model;
using ScreenShare.App.Features.Insights.Model;
using ScreenShare.App.Mvvm;

namespace ScreenShare.App.Features.Insights.HeaderStats.ViewModel;
...
public sealed class HeaderStatsViewModel : Observable
{
    ...
    public void Apply()
    {
        ...
        [
            ...
            // as the stream's own, a figure nobody took (Model/InsightsSnapshot.cs).
    ...
    /// </summary>
    private static string? Untimed(InsightsSnapshot reading, double? figure)
