...
/// <summary>
/// How a measurement reaches the screen, stated once for the whole insights surface rather than per render
/// function: an unmeasured figure prints an ellipsis, and two figures sharing a line are joined by a middle
/// dot (<c>docs/design-language.md</c>, "Wording").
///
...
public static class Figure
{
    ...
    /// <summary>A count: no decimals, so no format from the caller.</summary>
