...
/// Editing goes through the card's "Edit in setup" link alone, which is what keeps broadcast from becoming a
/// second editor.
/// </summary>
/// <remarks>
...
/// from: the key is that group's title, the value its own summary, which is <c>Summary.headline</c> narrowed
/// to one group.
