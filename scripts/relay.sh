...
# Built rather than `go run`, which puts a second process between this script and the service and
# leaves it running when the signal reaches the wrapper alone.
